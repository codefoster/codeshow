...
(function () {
    ...
    WinJS.UI.Pages.define("/demos/viewstates/viewstates.html", {
        // This function is called whenever a user navigates to this page. It
        // populates the page elements with the app's data.
        ready: function (element, options) {
            // TODO: Initialize the page here.
            pageTitle.innerText = getViewStateName();
            var attractions = [
            ...
            this.list = document.querySelector("#list").winControl;
            this.list.itemDataSource = attractionsList.dataSource;
            this.list.itemTemplate = document.querySelector("#template");
        ...
        updateLayout: function (element, viewState, lastViewState) {
            ...
            if (viewState == viewStates.snapped) {
                this.list.layout = new WinJS.UI.ListLayout();
            } else {
                this.list.layout = new WinJS.UI.GridLayout();
            }
