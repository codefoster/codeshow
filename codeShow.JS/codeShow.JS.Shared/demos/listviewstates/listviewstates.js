(function () {
    ...
    WinJS.UI.Pages.define("/demos/listviewstates/listviewstates.html", {
        init: function (element) {
            WinJS.Namespace.define("codeShow.Demos.listviewstates", {
                data: new WinJS.Binding.List(),
                stateChangedFunction: WinJS.Utilities.markSupportedForProcessing(function (e) {
                    var output = element.querySelector(".output");
                    output.innerHTML += e.srcElement.winControl.loadingState + "<br/>";
        ...
        ready: function (element, options) {
            ...
            attractions.forEach(function (a) { codeShow.Demos.listviewstates.data.push(a); });
        }
    });
})();
