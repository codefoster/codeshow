(function () {
    ...
    WinJS.UI.Pages.define("/demos/listviews/reorder/reorder.html", {
        init: function (element) {
            WinJS.Namespace.define("codeShow.Demos.listviews.reorder", {
        ...
        ready: function (element, options) {
            ...
            attractions.forEach(function (a) {
                codeShow.Demos.listviews.reorder.data.push(a);
            });
