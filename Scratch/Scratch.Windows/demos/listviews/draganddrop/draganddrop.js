(function () {
    ...
    WinJS.UI.Pages.define("/demos/listviews/draganddrop/draganddrop.html", {
        init: function (element) {
            WinJS.Namespace.define("codeShow.Demos.listviews.declarative", {
                data: new WinJS.Binding.List()
            });
        },
        ready: function (element, options) {
            element.querySelector(".win-listview").addEventListener("itemdragstart", function (e) {
                e.detail.dataTransfer.setData("Text", JSON.stringify(e.detail.dragInfo.getIndices()));
                debugger;
            });
            var attractions = [
            ...
            attractions.forEach(function (a) {
                codeShow.Demos.listviews.declarative.data.push(a);
            });
