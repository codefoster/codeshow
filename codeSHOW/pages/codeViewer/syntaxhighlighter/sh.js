...
(function () {
    ...
    function Brush() {
        ...
        var keywords = 'ascent azimuth background-attachment background-color background-image background-position ' +
						...
						'vertical-align visibility voice-family volume white-space widows width widths word-spacing x-height z-index ms-grid-columns ' +
						'ms-grid-rows ms-grid-column ms-grid-row ms-grid-row-span ms-grid-column-span';
        ...
        var values = 'above absolute all always aqua armenian attr aural auto avoid baseline behind below bidi-override black blink block blue bold bolder ' +
						...
						'lowercase lower-greek lower-latin lower-roman lower low ltr marker maroon medium message-box middle mix move ms-grid narrower ' +
        ...
        var fonts = '[mM]onospace [tT]ahoma [vV]erdana [aA]rial [hH]elvetica [sS]ans-serif [sS]erif [cC]ourier mono sans serif [sS]egoe UI';
