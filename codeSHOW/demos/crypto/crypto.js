(function () {
    ...
    WinJS.UI.Pages.define("/demos/crypto/crypto.html", {
        ready: function (element, options) {
            var that = this;

            //section 1: encoding and decoding
            this.encodeAndDecode();
        ...
        core: function () {
            var that = this;
            logElement = q(".crypto .core .log");
            this.clearLog();

            this.logLine("Enter a value and Create SHA-1...");

            q(".crypto .core button").onclick = function (e) {
                that.logLine(that.hash(q(".crypto .core input").value));
            };
        },
        hash: function(msg)
        {
